...
var input_category:any = document.getElementById('input_category');
var btn_filter_category: any = document.getElementById('btn_filter_category');
...
var sortPrices = (sort_type:string) => {
    let _product = products();
    if (sort_type == 'ASC') {
        let priceSort = product.sort(function (a:any, b:any) {
